          ...
          <div className="auth-intro">
            <div className="auth-intro-copy">
              ...
              <div className="auth-intro-note">
                ...
                <p>
                  Create one account and your future orders become faster, calmer, and easier to
                  manage across every Flawlez visit.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="auth-card-shell">
              <div className="auth-card-head">
                ...
                <div className="auth-card-meta">
                  ...
                  <span className="auth-card-pill muted">India OTP ready</span>
                </div>
                <h2>Sign Up</h2>
                <p>
                  {step === 1
                    ? "Start with Google or create your details first, then verify your phone number."
              ...
              {step === 1 ? (
                <>
                  <GoogleAuthButton
                    ...
                    dividerLabel="preferred sign up"
                  ...
                  <form onSubmit={handleRegister} className="auth-form">
                    <label className="auth-label">
                      ...
                      <input
                        ...
                        disabled={loading}
                      />
                      <span className="auth-label-hint">This becomes your Flawlez account handle.</span>
                    </label>
                    ...
                    <label className="auth-label">
                      ...
                      <span className="auth-label-hint">Used for OTP verification and order updates.</span>
                    </label>
                    ...
                    <p className="auth-form-footnote">
                      Google is the fastest way in. Manual signup keeps your phone-verified flow available.
                    </p>
